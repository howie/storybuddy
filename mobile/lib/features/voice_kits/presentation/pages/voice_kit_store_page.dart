      ...
      next.whenOrNull(
        ...
        data: (_) {
           if (previous?.isLoading == true) {
             ScaffoldMessenger.of(context).showSnackBar(
               const SnackBar(content: Text('下載成功！'), backgroundColor: Colors.green),
             );
        ...
        data: (kits) {
           ...
           return ListView.builder(
             ...
             itemBuilder: (context, index) {
               ...
               final isDownloading = downloadState.isLoading; // Simplified global loading, ideally per-item
                   ...
                   trailing: kit.isDownloaded
                       ...
                       : ElevatedButton(
                           onPressed: isDownloading ? null : () {
                             ref.read(downloadKitControllerProvider.notifier).downloadKit(kit.id);
                           },
                           child: isDownloading 
                             ? const SizedBox(
                                 width: 16, 
